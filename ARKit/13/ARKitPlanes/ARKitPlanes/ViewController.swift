...
extension ViewController: SCNPhysicsContactDelegate {
    ...
    //меттод делегатта, который говоритт о том чтто будет происходить при контактте
    //двух обьектов
    ...
    func physicsWorld(_ world: SCNPhysicsWorld, didBegin contact: SCNPhysicsContact) {
        ...
        //ЗДЕСЬ МЫ спрашиваем обьект с коромым произощел у более крупного ттела контактт
        //имеетт маску кубика
        if nodeB.physicsBody?.contactTestBitMask == BitMaskCategory.box {
            //если да, то кубику меняем цвет на крассный
