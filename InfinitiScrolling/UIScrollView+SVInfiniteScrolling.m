...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
    NSLog(@"КАКОГО ХЕРА ТЫ НЕ СРАБАТЫВАЕШЬ??");
...
- (UIActivityIndicatorView *)activityIndicatorView {
    if(!_activityIndicatorView) {
        ...
        _activityIndicatorView.color = [UIColor colorWithRed: 0 green: 1 blue:0 alpha:1];
        _activityIndicatorView.backgroundColor = [UIColor colorWithRed: 0 green: 1 blue:0 alpha:1];
