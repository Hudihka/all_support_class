...
SWIFT_CLASS("_TtC12AnyFormatKit24AttributedTextInputField")
@interface AttributedTextInputField : UITextField
/// Overriden text, that set text with attributes to attributedText property
@property (nonatomic, copy) NSString * _Nullable text;
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull defaultTextAttributes;
...
SWIFT_CLASS("_TtC12AnyFormatKit23AttributedTextInputView")
@interface AttributedTextInputView : UITextView
/// Overriden text, that set text with attributes to attributedText property
...
SWIFT_CLASS("_TtC12AnyFormatKit14TextInputField")
@interface TextInputField : AttributedTextInputField
@property (nonatomic, copy) NSString * _Nullable text SWIFT_UNAVAILABLE_MSG("use content instead");
@property (nonatomic, strong) NSAttributedString * _Nullable attributedText SWIFT_UNAVAILABLE_MSG("use attributedContent instead");
@property (nonatomic, strong) id <UITextFieldDelegate> _Nullable delegate SWIFT_UNAVAILABLE_MSG("use textInputDelegates and textInputFieldDelegates instead");
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TextInputField (SWIFT_EXTENSION(AnyFormatKit)) <UITextFieldDelegate>
...
SWIFT_CLASS("_TtC12AnyFormatKit13TextInputView")
@interface TextInputView : AttributedTextInputView
@property (nonatomic, copy) NSString * _Null_unspecified text SWIFT_UNAVAILABLE_MSG("use content instead");
@property (nonatomic, strong) NSAttributedString * _Null_unspecified attributedText SWIFT_UNAVAILABLE_MSG("use attributedContent instead");
@property (nonatomic, strong) id <UITextViewDelegate> _Nullable delegate SWIFT_UNAVAILABLE_MSG("use textInputDelegates and inputTextViewDelegates instead");
...
@interface TextInputView (SWIFT_EXTENSION(AnyFormatKit)) <UITextViewDelegate>
